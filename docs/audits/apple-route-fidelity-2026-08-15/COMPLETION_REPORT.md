...
The implementation now renders captured route-specific sections and long-form copy blocks in addition to the original shared hero, feature, accordion, comparison, editorial, and store compositions. Where available, up to five local Apple source images per route are displayed as controlled hero and gallery media. The generated route asset map currently provides source imagery for **144 of 272 routes**; the multi-asset pass adds richer image coverage to routes with meaningful Apple image candidates.
...
| Routes with remaining heading-structure discrepancy | 271 |
...
| Routes with content-coverage discrepancy | 100 |
| Routes marked fully verified | 0 |

## Interpretation

The work satisfies the requested **individual route inspection and evidence collection** requirement. It fixes the highest-leverage shared issues: route resolution, source-derived page copy, main-content extraction, representative interaction behavior, route-specific media loading, source-derived feature sections, and responsive image presentation.
